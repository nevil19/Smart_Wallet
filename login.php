...
// Process of logIn to Smartwalet 
// Check whether SignIn button is clicked or not 
...
if (isset($_POST['login'])) {
    if ($_POST['email'] == '') {
        ...
        if ($_POST['password'] == '') {
            ...
            // Fetching the Data from the SigIn Form       
            $Email = $mysqli->real_escape_string($_POST['email']);
            $Password = md5($_POST['password']);


            // SQL to check whether the with username and Password Exists or Not 
                ...
                if ($num_of_rows = $stmt->num_rows >= 1) {
                    ...
                    if (mysqli_num_rows($b) >= 1) {
                      echo '<META HTTP-EQUIV="Refresh" Content="0; URL=index.php">';
                        ...
                        $c = "INSERT INTO category(UserId, CategoryName, Level) VALUES ($UserIds, 'Salary', 1), ($UserIds, 'Allowance', 1), ($UserIds, 'Petty Cash', 1), ($UserIds, 'Bonus', 1), ($UserIds, 'Food', 2),
